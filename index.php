    ...
    <section id="tentang-kami" class="scroll-mt-24 py-20 bg-white pt-28 -mt-16">
      <div class="container mx-auto px-6 max-w-6xl">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <h4 class="text-blue-600 font-bold mb-2 uppercase tracking-wide">Mengenal EQ - Math</h4>
                    <h2 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-6">Ubah Ketakutan Menjadi Kekuatan Berlogika</h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 font-medium text-gray-800">
                        <div class="flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-3 rounded-xl mr-4 shadow-sm">🚀</div>
                            <div>
                                <h5 class="font-bold text-gray-900">Kurikulum Adaptif</h5>
                                <p class="text-sm text-gray-500 font-normal mt-1">Materi terstruktur sesuai standar sekolah</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-3 rounded-xl mr-4 shadow-sm">👨‍🏫</div>
                            <div>
                                ...
                                <p class="text-sm text-gray-500 font-normal mt-1">Pengajar kompeten di bidangnya</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-3 rounded-xl mr-4 shadow-sm">⏰</div>
                            <div>
                                ...
                                <p class="text-sm text-gray-500 font-normal mt-1">Bebas atur waktu belajarmu sendiri</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-3 rounded-xl mr-4 shadow-sm">💻</div>
                            <div>
                                ...
                                <p class="text-sm text-gray-500 font-normal mt-1">Pendaftaran & pembayaran terintegrasi</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative mt-10 md:mt-0">
                    <div class="absolute inset-0 bg-blue-600 rounded-3xl transform translate-x-4 translate-y-4 -z-10 opacity-20"></div>
                    <img src="./assets/images/about-math.jpg" alt="Belajar Matematika Interaktif" class="rounded-3xl shadow-2xl w-full object-cover aspect-[4/3] border border-gray-100">
                </div>
